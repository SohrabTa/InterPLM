...
PAIRINGS="/workspace/data/crosscoder_eval/auxfix/baseline/uniprotkb_modern_score45_67k/test_counts/heldout_all_top_pairings.csv"
...
srun --container-image="nvcr.io/nvidia/pytorch:25.12-py3" \
     ...
     --layer crosscoder \
     --dashboard_name prott5_crosscoder_auxfix_baseline \
     --model_name prott5 \
