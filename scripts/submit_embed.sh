...
srun --container-image="nvcr.io/nvidia/pytorch:25.12-py3" \
     ...
     --input_dir /workspace/data/uniprotkb_modern_score5_35k/processed_annotations/ \
    --output_dir /workspace/data/uniprotkb_modern_score5_35k/analysis_embeddings/prott5/layer_crosscoder \
